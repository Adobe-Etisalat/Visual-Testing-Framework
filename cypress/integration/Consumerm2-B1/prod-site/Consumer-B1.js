...
describe("visual test of walls site page",function(){
    ...
    beforeEach(function()
    {
        cy.fixture("/Consumerm2/production/Consumer-B1").then((data) =>{
            this.testdata=data
        }) 
    })
    ...
    it("open-page-for visual validation for walls",function(){
        ...
        arrayOsPage.forEach(element => {
           cy.log(i)
            ...
            cy.window().then(cyWindow => scrollToBottom({frequency: 10, timing: 10000 ,remoteWindow: cyWindow }));
         i=i+1
         cy.log(i)
       cy.percySnapshot("Consumerm2-bat1-page-"+i);
        });
       })
}) 
